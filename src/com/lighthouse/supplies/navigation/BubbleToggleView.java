...
import com.lighthouse.supplies.navigation.ViewUtils;
        ...
        if (attrs != null) {
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
                    icon = ta.getDrawable(R.styleable.BubbleToggleView_supplies_icon);
                else
                icon = AppCompatResources.getDrawable(getContext(), ta.getResourceId(R.styleable.BubbleToggleView_supplies_icon, R.drawable.default_icon));
                iconWidth = ta.getDimension(R.styleable.BubbleToggleView_supplies_iconWidth, iconWidth);
                iconHeight = ta.getDimension(R.styleable.BubbleToggleView_supplies_iconHeight, iconHeight);
                shape = ta.getDrawable(R.styleable.BubbleToggleView_supplies_shape);
                shapeColor = ta.getColor(R.styleable.BubbleToggleView_supplies_shapeColor, shapeColor);
                showShapeAlways = ta.getBoolean(R.styleable.BubbleToggleView_supplies_showShapeAlways, false);
                title = ta.getString(R.styleable.BubbleToggleView_supplies_title);
                titleSize = ta.getDimension(R.styleable.BubbleToggleView_supplies_titleSize, titleSize);
                colorActive = ta.getColor(R.styleable.BubbleToggleView_supplies_colorActive, colorActive);
                titleColorActive = ta.getColor(R.styleable.BubbleToggleView_supplies_titleColorActive, colorActive);
                colorInactive = ta.getColor(R.styleable.BubbleToggleView_supplies_colorInactive, colorInactive);
                isActive = ta.getBoolean(R.styleable.BubbleToggleView_supplies_active, false);
                animationDuration = ta.getInteger(R.styleable.BubbleToggleView_supplies_duration, DEFAULT_ANIM_DURATION);
                internalPadding = (int) ta.getDimension(R.styleable.BubbleToggleView_supplies_padding, internalPadding);
                titlePadding = (int) ta.getDimension(R.styleable.BubbleToggleView_supplies_titlePadding, titlePadding);
            } finally {
                ta.recycle();
            }
        }
